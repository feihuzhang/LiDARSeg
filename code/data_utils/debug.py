...
def rotatexy_flip(points, angle=30, flip=True, flip_ratio=0.25):
...
#            point_set = rotatexy_flip(data)
            ...
            point_set = rotatexy_flip(point_set)
        ...
        # resample
            ...
            instance = np.zeros([self.npoints], dtype='float32')
