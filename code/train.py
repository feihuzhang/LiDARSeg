...
#            print(points.size(), label.size(), target.size(), mask.size())
#            quit()
...
#            print(target, ins)
            ...
            if 0:
                ...
                points = provider.rotation_aug(points)
                if 0:
...
#            print(total_points)
            ...
            for i in range(num_devices):
                ...
                inputi = input_coding(batch['x'])
#                print(inputi.features.shape, inputi.spatial_size)
...
#            print("end ...") 
            ...
            for i in range(num_devices):
                temp = predictions[i]['output1'].view(-1, num_classes)
