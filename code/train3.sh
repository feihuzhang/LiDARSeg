...
export PYTHONPATH=/home/feihu/Desktop/MinkowskiEngine/build/lib:${PYTHONPATH}
fi
CUDA_VISIBLE_DEVICES=0,1 python train3.py --lr_decay=0.04 --learning_rate=0.1 --optimizer='SGD' --model pointnet2_part_seg_msg --normal --log_dir sparse3
#6600 6793
#6589 6369
